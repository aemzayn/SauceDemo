...
describe("Inventory", () => {
  ...
  it("should add item to cart", () => {
    ...
    cy.getBySel("add-to-cart-sauce-labs-bike-light")
      .should("be.visible")
      .click();
    ...
    cy.get(".shopping_cart_badge").should("be.visible").and("contain", "5");
  ...
  it("should sort items from A to Z", () => {
    cy.getBySel("product_sort_container").should("be.visible").select("az");
  ...
  it("should sort items from Z to A", () => {
    cy.getBySel("product_sort_container").should("be.visible").select("za");
  ...
  it("should sort items by price from low to high", () => {
    cy.getBySel("product_sort_container").should("be.visible").select("lohi");
  ...
  it("should sort items by price from high to low", () => {
    cy.getBySel("product_sort_container").should("be.visible").select("hilo");
